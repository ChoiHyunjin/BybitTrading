...
|---|-------|----------|------|--------|
| 1 | **핵심 모델 & 지표 엔진**: Price/Trade/BacktestResult 모델과 볼린저밴드/이동평균 지표 | Must | M | Done (Sprint 1) |
| 2 | **백테스팅 엔진**: 전략-엔진 분리, 과거 데이터로 전략 실행 | Must | L | Done (Sprint 2) |
| 3 | **Bybit API 연동**: 과거 캔들 데이터 fetch | Must | M | Done (Sprint 3) |
| 4 | **백테스팅 결과 UI**: 수익률/승률/MDD/거래내역 화면 | Must | L | Done (Sprint 4) |
| 5 | **백테스팅 설정 UI**: 기간/심볼/초기자본 설정 및 실행 | Should | M | Done (Sprint 5) |
